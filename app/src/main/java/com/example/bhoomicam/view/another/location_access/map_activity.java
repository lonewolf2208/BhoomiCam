    ...
    private void initGoogleMapLocation() {
        ...
        locationResponse.addOnSuccessListener(this, new OnSuccessListener<LocationSettingsResponse>() {
            ...
            public void onSuccess(LocationSettingsResponse locationSettingsResponse) {
                ...
                //
                if (ActivityCompat.checkSelfPermission(map_activity.this, Manifest.permission.ACCESS_FINE_LOCATION)
                        != PackageManager.PERMISSION_GRANTED) {
                    return;
                }
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                switch (statusCode){
                    case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                        ...
                        Log.e("onFailure", "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF&&&&&&&&&&&&&& ::::"+ errorMessage);
                }
            }
        });
    }

//    @Override  extends AppCompatActivity
