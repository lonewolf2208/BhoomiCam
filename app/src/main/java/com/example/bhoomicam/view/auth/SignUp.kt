...
class SignUp : Fragment() {
    ...
    override fun onCreateView(
        ...
        // initializing variables for button and Edittext.
        edtPhone =binding.PhoneNumber
        edtOTP = binding.Otp
        verifyOTPBtn = binding.SingnUpButton
        generateOTPBtn = binding.button9
        ...
        verifyOTPBtn!!.setOnClickListener {
            ...
            if(TextUtils.isEmpty(binding.SignUpName.text.toString())){
                binding.SignUpNameContainer.helperText="Enter Your Name"
            }else {
